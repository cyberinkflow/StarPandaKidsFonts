...
「星光小熊貓體幼兒風」是寫字熊貓**白河**透過 [字嗨字體產生器](https://buttaiwan.github.io/writemyfont/) 自製的第一個手寫字型。
...
- [星光小熊貓體幼兒風 beta 2.0](https://github.com/cyberinkflow/StarPandaKidsFonts/raw/main/StarPandaKidsBeta2.0.otf)
...
- 2025.09 - 星光小熊貓體幼兒風 Beta 2.0 正式發布，修改了一些行書、古字寫法，更接近標準字體

### 製作進度
- 2025.09 - 星光小熊貓體幼兒風完整版 書寫製作中（第一階段目標：完成中文字型包）
